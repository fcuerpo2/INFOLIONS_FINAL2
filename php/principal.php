...
<div id='cabecera' class='navbar-fixed-top' style='position:sticky;'>
 ...
 echo"                              </div>
  		  	...
  		  	<div id='anuncio-left' style='background-color: #333; min-height: 40px; margin-bottom: 10px; border-radius: 10px; color: #fff;'></div>
  		</div>
...
<?php
  echo"     <div id='anuncio-right' style='background-color: #333; min-height: 40px; margin-bottom: 10px; border-radius: 10px; color: #fff;'></div>
  		</div>
  	</div>		        
	</center>";
}
